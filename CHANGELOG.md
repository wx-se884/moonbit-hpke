...
- Added reproducible native benchmark suites and reference measurements.
- Added source statistics and serial acceptance-check scripts.
- Added a tested package README and multi-platform CI validation.
